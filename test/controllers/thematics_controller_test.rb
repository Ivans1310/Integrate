...
class ThematicsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create thematic" do
    assert_difference('Thematic.count') do
      post thematics_url, params: { thematic: { location_id: @thematic.location_id, nombre_te: @thematic.nombre_te } }
    end
  ...
  test "should update thematic" do
    patch thematic_url(@thematic), params: { thematic: { location_id: @thematic.location_id, nombre_te: @thematic.nombre_te } }
